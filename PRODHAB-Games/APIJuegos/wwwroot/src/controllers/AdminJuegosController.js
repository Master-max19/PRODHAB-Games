            ...
            externalActions: [
                {
                    label: "🕹 Prueba",
                    action: "probar",
                    tooltip: "Visualizar el juego.",
                },
                {
                    label: "👁 Estado",
                    action: "ver-estado",
                    tooltip: "Controla la visibilidad de los juegos.",
                },
                {
                    label: "⚙ Ajustes",
                    action: "ver",
                    tooltip: "Modificar el juego.",
                }
...
`;
        ...
        tabla.addEventListener("row-action", async (e) => {
            ...
            if (e.detail.action === "probar") {
                ModalMenuJuegosPRODHAB.openAutoModalGames(datos.idJuego, datos.idTipoJuego);
            }
