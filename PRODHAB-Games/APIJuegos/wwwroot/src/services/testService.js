...
const testService = (() => {
    ...
    return {
        obtenerPreguntasTest, enviarRespuestasTest,
        convertirLinkConEstiloTest, mapearPreguntaAPITest, interpolarMensajeTest
    }
})();