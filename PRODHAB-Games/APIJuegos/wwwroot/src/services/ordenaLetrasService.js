...
const OrdenaLetrasService = (() => {
   ...
   */
  async function obtenerTextoYPalabras(idOrdenar) {
    try {
      ...
      const res = await fetch(`${CONFIG_JUEGO_PRODHAB.apiUrl}/api/PalabraJuego/solo-palabras/${idOrdenar}`);
