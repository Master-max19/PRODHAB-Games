(() => {
    ...
    function recuperarCuenta() {
        utilModalJuegos3.mostrarModalConInput(
            ...
            (correoGlobal) => {
                usuarioService.solicitarCodigo(correoGlobal)
                    .then(() => {
                                ...
                                utilModalJuegos3.mostrarModalConInput(
                                    ...
                                    (codigoGlobal) => {
                                        utilModalJuegos3.mostrarModalConInput(
                                            ...
                                            (nuevaClaveGlobal) => {
                                                usuarioService.restablecerClave(correoGlobal, codigoGlobal, nuevaClaveGlobal)
                                                    .then(() => {
                                                        utilModalJuegos2.mostrarMensajeModal(
    ...
    document.addEventListener("recovery-event", () => {
        recuperarCuenta();
    });
