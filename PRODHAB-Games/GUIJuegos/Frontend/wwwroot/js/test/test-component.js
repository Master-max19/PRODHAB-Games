class TestComponent extends HTMLElement {
    ...
    constructor() {
        ...
        this.characterPNG = this.getAttribute("character_png") || `${TestComponent.componente.public}/../../images/character.png`;
 ...
 */
    ...
    actualizarResumen(fallos, correctas, calificacion, reiniciar = false, mensaje) {
    ...
    async cargarTest(limpiar = true) {
        ...
        if (preguntasAPI.length > 0) {
            ...
            this.actualizarResumen(0, 0, 0, true, juegoConPreguntas.detalle);
        } else {
            const divStack = this.shadowRoot.getElementById('div-stack');
